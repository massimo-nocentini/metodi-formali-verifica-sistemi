...
\subsubsection{Transient expected cumulated missed requests }
...
In \autoref{fig:expected-cumulated-missed-requests} we report the
...
In \autoref{fig:expected-cumulated-power} we report the results of the
