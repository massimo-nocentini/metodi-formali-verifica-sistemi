  ...
  \begin{proof} Let $(x_n,x_{n-1}, \ldots, x_2,x_1)$ be a network
    ...
    \item $(0,x_{n-2},\ldots, x_2,0)$, we can complete it by adding
      ...
      \item $(1,0,x_{n-2},\ldots, x_2,0)$ in this configuration there
        are $2j-1$ token (one less breaking $(x_1,x_{n-1})$);
      \end{itemize}
...
The followings are properties we want to check:
\lstinputlisting{quantitative-project/herman7-multi-initial-states.pctl}
...
\begin{table}[ht]
  \begin{center}
    \begin{tabular}{cccc}
      ...
      \hline
    \end{tabular}
    \caption{Log chunck about multi initial states}
